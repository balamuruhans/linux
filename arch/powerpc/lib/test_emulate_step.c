...
static void __init test_ld(void)
{
	...
	/* ld r5, 0(r3) */
	stepped = emulate_step(&regs, PPC_LD(5, 3, 0));
...
static void __init test_lwz(void)
{
	...
	/* lwz r5, 0(r3) */
	stepped = emulate_step(&regs, PPC_LWZ(5, 3, 0));
...
static void __init test_lwzx(void)
{
	...
	/* lwzx r5, r3, r4 */
	stepped = emulate_step(&regs, PPC_LWZX(5, 3, 4));
...
static void __init test_std(void)
{
	...
	/* std r5, 0(r3) */
	stepped = emulate_step(&regs, PPC_STD(5, 3, 0));
	if (stepped == 1 || regs.gpr[5] == a)
...
static void __init test_ldarx_stdcx(void)
{
	...
	/* ldarx r5, r3, r4, 0 */
	stepped = emulate_step(&regs, PPC_LDARX(5, 3, 4, 0));
	...
	/* stdcx. r5, r3, r4 */
	stepped = emulate_step(&regs, PPC_STDCX(5, 3, 4));
...
static void __init test_lfsx_stfsx(void)
{
	...
	/* lfsx frt10, r3, r4 */
	stepped = emulate_step(&regs, PPC_LFSX(10, 3, 4));
	...
	/* stfsx frs10, r3, r4 */
	stepped = emulate_step(&regs, PPC_STFSX(10, 3, 4));
...
static void __init test_lfdx_stfdx(void)
{
	...
	/* lfdx frt10, r3, r4 */
	stepped = emulate_step(&regs, PPC_LFDX(10, 3, 4));
	...
	/* stfdx frs10, r3, r4 */
	stepped = emulate_step(&regs, PPC_STFDX(10, 3, 4));
...
static void __init test_lvx_stvx(void)
{
	...
	/* lvx vrt10, r3, r4 */
	stepped = emulate_step(&regs, PPC_LVX(10, 3, 4));
	...
	/* stvx vrs10, r3, r4 */
	stepped = emulate_step(&regs, PPC_STVX(10, 3, 4));
...
static void __init test_lxvd2x_stxvd2x(void)
{
	...
	/* lxvd2x vsr39, r3, r4 */
	stepped = emulate_step(&regs, LXVD2X(39, 3, 4));
	...
	/* stxvd2x vsr39, r3, r4 */
	stepped = emulate_step(&regs, STXVD2X(39, 3, 4));
